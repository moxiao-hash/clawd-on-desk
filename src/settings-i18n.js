...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sectionMusicDance: "Music Dance",
      rowMusicDanceEnabled: "Dance to music",
      rowMusicDanceEnabledDesc: "Pet switches to a juggling animation when a music app is playing audio. Only recognises the apps listed below.",
      rowMusicAppNames: "Music apps",
      rowMusicAppNamesDesc: "Process names of music apps to detect. Add or remove names as needed.",
      rowMusicAppNamesPlaceholder: "App name",
      rowSize: "Size",
    ...
    zh: {
      ...
      sectionMusicDance: "音乐舞动",
      rowMusicDanceEnabled: "随音乐起舞",
      rowMusicDanceEnabledDesc: "当音乐软件播放音频时，桌宠自动切换为杂耍动画。仅识别下方列出的音乐应用。",
      rowMusicAppNames: "音乐应用",
      rowMusicAppNamesDesc: "需要识别的音乐软件进程名。可按需增删。",
      rowMusicAppNamesPlaceholder: "应用名",
      rowSize: "大小",
    ...
    "zh-TW": {
      ...
      sectionMusicDance: "音樂舞動",
      rowMusicDanceEnabled: "隨音樂起舞",
      rowMusicDanceEnabledDesc: "音樂軟體播放音訊時，桌寵自動切換為雜耍動畫。僅識別下方列出的音樂應用。",
      rowMusicAppNames: "音樂應用",
      rowMusicAppNamesDesc: "要識別的音樂軟體進程名。可按需增刪。",
      rowMusicAppNamesPlaceholder: "應用名",
      rowSize: "大小",
    ...
    ko: {
      ...
      sectionMusicDance: "Music Dance",
      rowMusicDanceEnabled: "음악에 맞춰 춤추기",
      rowMusicDanceEnabledDesc: "음악 앱에서 오디오를 재생할 때 펫이 저글링 애니메이션으로 전환됩니다. 아래 목록에 있는 앱만 인식합니다.",
      rowMusicAppNames: "음악 앱",
      rowMusicAppNamesDesc: "감지할 음악 앱의 프로세스 이름입니다. 필요에 따라 추가하거나 제거하세요.",
      rowMusicAppNamesPlaceholder: "앱 이름",
      rowSize: "크기",
    ...
    ja: {
      ...
      sectionMusicDance: "ミュージックダンス",
      rowMusicDanceEnabled: "音楽で踊る",
      rowMusicDanceEnabledDesc: "音楽アプリがオーディオを再生しているときに、ペットがジャグリングアニメーションに切り替わります。下記のアプリのみ認識します。",
      rowMusicAppNames: "音楽アプリ",
      rowMusicAppNamesDesc: "検出する音楽アプリのプロセス名です。必要に応じて追加/削除してください。",
      rowMusicAppNamesPlaceholder: "アプリ名",
      rowSize: "サイズ",
